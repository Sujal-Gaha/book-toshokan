...
-- DropForeignKey
ALTER TABLE "FeedbackComment" DROP CONSTRAINT "FeedbackComment_userId_fkey";

-- DropForeignKey
ALTER TABLE "UserBookSubscription" DROP CONSTRAINT "UserBookSubscription_userId_fkey";
